/**
 * Tabler-based SVG icon components for the demo toolbar.
 *
 * Sources: apps/demo/Icons/*.svg (Tabler Icons, outline style).
 * Missing icons (playback, zoom, trim) are hand-drawn in the same
 * 24×24 / stroke-1.5 / round-cap style for visual consistency.
 */
...
/** Selection (pointer) — from pointer.svg */
...
/** Razor (scissors) — from scissors.svg */
...
/** Ripple-trim — bracket-arrows (custom, Tabler style) */
...
/** Roll-trim (arrows-left-right) — from roll.svg */
...
/** Slip (arrows-move-horizontal) — from slip.svg */
...
/** Slide (caret-left-right) — from slide.svg (filled) */
...
/** Undo (arrow-back-up) — from undo.svg */
...
/** Redo (arrow-forward-up) — from redo.svg */
